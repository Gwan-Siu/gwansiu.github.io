...
&=E_{x}\[E_{D}\[g^{D}(x)^{2}-\hat{g}^{D}(x)^{2}]+(\hat{g^{D}(x)^{2}}-f(x))^{2}\] \\
&=E_{x}\[E_{D}[g^{D}(x)^{2}]-2\hat{g}^{D}(x)f(x)+f^{2}(x)\] \\
&=E_{x}\[E_{D}[g^{D}(x)^{2}]-\hat{g}^{D}(x)^{2}+\hat{g}^{D}(x)^{2}-2\hat{g}^{D}(x)f(x)+f^{2}(x)] \\
&=E_{x}\[E_{D}\[g^{D}(x)^{2}-\hat{g}^{D}(x)^{2}\]+(\hat{g}^{D}(x)-f(x))^{2}\] \\
&=E_{x}\[E_{D}\[g^{D}(x)^{2}-\hat{g}^{D}(x)^{2}\]\]+E_{x}\[(\hat{g}^{D}(x)-f(x))^{2}\]
\end{aligned}
$$

其中, $\text{bias(x)=E_{x}\[(\hat{g}^{D}(x)-f(x))^{2}}\]$,$\text{Var(x)}=E_{D}[g^{D}(x)^{2}-\hat{g}^{D}^{2}(x)]$. 
...
**bias很大，说明模型欠拟合；Variance很大，说明模型过拟合。**
